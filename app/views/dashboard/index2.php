<div class="container mt-5 " style="max-width: 1000px;" id="user_bar">
   <div class="container my-5">
      <ul class="nav nav-tabs" id="paginationBar">
         ...
         <li class="nav-item">
            <a class="nav-link active" href="<?= BASEURL ?>/?url=Dashboard/index2">Games</a>
         </li>
         <li class="nav-item">
                        ...
                        <div id="collapse<?= $game['id']; ?>" class="accordion-collapse collapse" aria-labelledby="heading<?= $game['id']; ?>" data-bs-parent="#gamesAccordion">
                           <div class="accordion-body d-flex flex-row">
                              ...
                              <div class="container details col-1">
                                 ...
                                 <button type="button" class="btn btn-warning btn-sm m-auto updateGame" data-bs-toggle="modal" data-bs-target="#updateDataGame" data-id="<?= $game['id']; ?>" data-developer_id="<?= $game['developer_id']; ?>" data-title="<?= $game['title']; ?>" data-description="<?= $game['description']; ?>" data-price="<?= $game['price']; ?>" data-release_date="<?= $game['release_date']; ?>" data-file_path="<?= $game['file_path']; ?>" onclick="return confirm('Are you sure you want to delete this?')">
               ...
               <div class="container table-container mt-5 d-flex flex-column justify-content-between shadow" style="max-width: 1000px;">
                        ...
                        <tbody id="wishTable">
                           ...
                           ?>
                                 <tr>
                                    ...
                                    <?php $no += 1; ?>
                                    <td class="col-1"><?= $wish['id']; ?></td>
                                    <td class="col-2"><?= $customer['full_name']; ?></td>
                                    <td class="col-3"><?= $game['title']; ?></td>
                  ...
                  <nav class="d-flex justify-content-between mt-3">
                     <div class="container">
                        ...
                        <button type="submit" class="btn btn-danger btn-sm m-auto disabled" id="deleteSelectedWishs" onclick="return confirm('Are you sure you want to delete this?')">
                           Delete
                        </button>
                     </div>
                  </nav>
                  ...
                  <tbody id="reviewTable">
                     ...
                     ?>
                           <tr>
                              ...
                              <td class="col-1">
                                 <a href="<?= BASEURL ?>/?url=Game/deleteReviews/Dashboard/index2&reviewId=<?= $review['id'] ?>" class="btn btn-danger btn-sm m-auto" onclick="return confirm('Are you sure you want to delete this review?')">
                                    Delete
                                 </a>
                              </td>
                           </tr>
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form id="updateForm" action="<?= BASEURL ?>/?url=Game/updateWish/Dashboard/index" method="post">
                  <div class="mb-3">
                     <label for="updateCustId" class="form-label">Customer</label>
                     <select class="form-select" id="updateCustId" name="custId">
                  ...
                  <div class="mb-3">
                     <label for="updateWishGameId" class="form-label">Game</label>
                     <select class="form-select" id="updateWishGameId" name="gameId">
